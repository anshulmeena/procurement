...
Epoch.prototype.calConfig = function () //PRIVATE: initialize calendar variables
{
	...
	this.rangeYearLower = 2010;
	this.rangeYearUpper = 2014;
	this.minDate = new Date(2010,0,1);
	this.maxDate = new Date(2014,0,1);
...
{
	if(!format) { // the default date format to use - can be customized to the current locale IMPORTANT
		format = 'm/d/Y';
	}
